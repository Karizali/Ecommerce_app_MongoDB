    ...
    <>
      <Card sx={{ minWidth: 275, maxWidth: 500, margin: 2 }}>
        <form onSubmit={formik.handleSubmit}>
          ...
          <CardActions>
            <Button type="submit" size="small" variant="contained">Add Product</Button>
          </CardActions>
        </form>
      </Card>
      <div>
        {products.map((product) => (
          <Card key={product._id} sx={{ maxWidth: 345, margin: "1rem", cursor: "pointer" }}>
            {(isEditing && editingProducts.id === product._id) ?
                  ...
                  <CardContent>
                    ...
                    >
                      <TextField
                        ...
                        fullWidth label="Product Name" />
                      {editformik.touched.editProductName && editformik.errors.editProductName ? (
                        <div className="error">{editformik.errors.editProductName}</div>
                      ) : null}
                    </Box>
                    <Box
                      sx={{
                    ...
                    >
                      <TextField
                        ...
                        fullWidth label="Product Price" />
                      {editformik.touched.editProductPrice && editformik.errors.editProductPrice ? (
                        <div className="error">{editformik.errors.editProductPrice}</div>
                      ) : null}
                    </Box>
                    <Box
                      sx={{
                    ...
                    >
                      <TextField
                        ...
                        fullWidth label="Product Description" />
                      {editformik.touched.editProductDescription && editformik.errors.editProductDescription ? (
                        <div className="error">{editformik.errors.editProductDescription}</div>
                      ) : null}
                    </Box>
                  </CardContent>
                  <CardActions>
              ...
              :
              <>
                <CardMedia sx={{ height: 140 }} image={"https://cdn.dummyjson.com/product-images/2/2.jpg"} title={product.name} />
                <CardContent>
                  <Typography
                    gutterBottom
                    variant="h5"
                ...
                <CardActions>
                  ...
                  <Button size="small" onClick={() => {
                    ...
                    editformik.setFieldValue("editProductDescription", product.description)
                    editformik.setFieldValue("editProductPrice", product.price)
                  }}>Edits</Button>
